...
//		logger= Logger.getLogger("nopcommerce");//.getLogger(name of project)
//	    PropertyConfigurator.configure("Log4j.properties");//.configure(location of Log4j file if it is not inside project directory but 
	    //write Log4j.properties if it is present in project)
...
//	driver= new ChromeDriver();
	...
	public  String user_enter_customer_info() throws InterruptedException {
